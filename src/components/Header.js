...
export default function Header() {
  ...
  return (
    <header>
      <nav className="flex justify-between items-center h-12 px-4 shadow-md bg-gray-800 text-white h-14 bg-gradient-to-r from-indigo-500 via-purple-500 to-indigo-500">
